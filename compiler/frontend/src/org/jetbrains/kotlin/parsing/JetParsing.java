...
//        else
    ...
    public IElementType parseProperty(boolean local) {
        ...
        if (local) {
            ...
            if (accessorKind != null) {
                parsePropertyGetterOrSetter(accessorKind == AccessorKind.GET ? AccessorKind.SET : AccessorKind.GET);
            }
     ...
     */
    @Nullable
    private AccessorKind parsePropertyGetterOrSetter(@Nullable AccessorKind allowedKind) {
        ...
        if (allowedKind != null && accessorKind != allowedKind) {
            getterOrSetter.rollbackTo();
            return null;
        }
