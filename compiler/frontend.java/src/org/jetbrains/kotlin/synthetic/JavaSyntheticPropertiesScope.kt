...
class JavaSyntheticPropertiesScope(storageManager: StorageManager, private val lookupTracker: LookupTracker) : KtScopeImpl() {
    ...
    private fun syntheticPropertyInClassNotCached(ownerClass: ClassDescriptor, name: Name): SyntheticPropertyHolder {
        ...
        fun result(descriptor: PropertyDescriptor?, getterNames: Sequence<Name>, setterName: Name? = null): SyntheticPropertyHolder {
            if (descriptor == null && lookupTracker == LookupTracker.DO_NOTHING) SyntheticPropertyHolder.EMPTY
            ...
            val names =
                    if (lookupTracker == LookupTracker.DO_NOTHING) {
                        ...
                        getterNames.toList() + setterName.singletonOrEmptyList()
                    }
        ...
        val getMethod = possibleGetMethodNames
                                .flatMap { memberScope.getFunctions(it, NoLookupLocation.FOR_ALREADY_TRACKED).asSequence() }
                                .singleOrNull {
